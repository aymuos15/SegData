#!/usr/bin/env python3
"""Dataset statistics and connected component analysis for BUS-BRA 2D segmentation.
...
class DatasetAnalyzer:
    ...
    def count_tumors(self, label_array: np.ndarray) -> Dict:
        ...
        # For 2D, use 8-connectivity (neighboring pixels including diagonals)
...
def main():
    parser = argparse.ArgumentParser(
        description="Analyze BUS-BRA dataset statistics and tumor counts"
    )
    parser.add_argument(
        "--dataset-dir",
